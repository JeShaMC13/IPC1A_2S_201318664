...
public class PrincipalSalvador {
	public PrincipalSalvador(){
    ...
    public PrincipalSalvador(String Nombre, int Piso, int Habitaciones,  String Tipohabitaciones){
    	this.Nombre = Nombre;
	...
	public PrincipalSalvador(JTextField nombre2, JComboBox piso2,JSpinner habitaciones2, JTextField tipohabitaciones2) {
