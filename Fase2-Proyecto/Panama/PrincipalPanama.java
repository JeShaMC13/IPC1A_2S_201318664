...
public class PrincipalPanama {
	public PrincipalPanama(){
   ...
   public PrincipalPanama(int Dia, String Mes, int Habitaciones, int Hospedaje,String Tipohabitaciones, String Tipodepago){
	this.Dia=Dia;
	this.Mes=Mes;
